...
Determine the current season based on the location's hemisphere and the provided current month. The 'currentSeason' field MUST be one of the following exact strings: 'Spring', 'Summer', 'Autumn', or 'Winter'.
